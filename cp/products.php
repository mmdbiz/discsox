...
<td align=left valign=top>
						...
						<?php endif;?>	
						<tr>
						  <td align=right valign=top><strong class="red">Discontinued:</strong></td>
						  <td align=left valign=top><?=$data['discontinued'];?></td>
					  </tr>
						<tr>
						  <td align=right valign=top><strong class="red">Replacement:</strong></td>
						  <td align=left valign=top>
                          <textarea name="replacement" rows=1 cols=59 wrap=virtual ID="Textarea5"><?=stripslashes($data['replacement']);?></textarea>
                          <!--<input type=text name="replacement" value="<?=$data['replacement'];?>" size=60 ID="Text17">--> </td>
					  </tr>
						<tr>
						  <td align=right valign=top><strong class="red">Replacement Filename:</strong></td>
						  <td align=left valign=top><textarea name="replacement_filename" rows=1 cols=59 wrap=virtual ID="replacement_filename"><?=stripslashes($data['replacement_filename']);?>
                        </textarea>
						    <!--<input type=text name="replacement" value="<?=$data['replacement'];?>" size=60 ID="Text17">--></td>
					  </tr>
						<tr>
...
<td align=left valign=top>
						...
						<tr>
						  <td colspan="2" align=center valign=top><h3>Summary Item Config</h3></td>
					  </tr>
						<tr>
						  <td align=right valign=top><strong class="red">Displ. AddToCart Button:</strong></td>
						  <td align=left valign=top><?=$data['summary_add_to_cart'];?></td>
					  </tr>
						<tr>
						  <td align=right valign=top><strong class="red">Link to detail page insted of picture pop-up:</strong></td>
						  <td align=left valign=top><?=$data['summary_detail_link'];?> <div style="float: right; margin-right: 150px;">setting this to true links to items detail page<br>
					      setting this to false enables pop-up picture</div></td>
					  </tr>
						<tr>
						  <td align=right valign=top><strong class="red">New Product:</strong></td>
						  <td align=left valign=top><?=$data['new_product'];?> <div style="float: right; margin-right: 150px;">setting this to true displays NEW!<br>
					      on overview and details page</div></td>
					  </tr>
						<tr>
						  <td colspan="2" align=right valign=top><hr></td>
					  </tr>
						<tr>
                          <td align=right valign=top><strong class="red">Item Type</strong></td>
						  <td align=left valign=top><input type=text name="item_type" value="<?=$data['item_type'];?>" size=60 ID="Text4">
                          </td>
					  </tr>
						<tr>
...
<td align=left valign=top>
						...
						<tr>
		  					<td align=right valign=top><a href="#MoreInfo"><strong class="red">Link Path</strong></a>:</td>
<td align=left valign=top>
		    					<input type=text name="link_path" value="<?=$data['link_path'];?>" size=60 ID="Text17">							</td>
						</tr>
						<tr>
