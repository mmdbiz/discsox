...
<html>
	...
	<body style="margin-left:10px;margin-top:30px;">
		...
		<form name="import" method="post" action="import.php" enctype="multipart/form-data">
			...
			<table border="0" cellpadding="3" cellspacing="0" align="center" width="600">
				...
				<tr>
					...
					<td>
						<input type="radio" name="overwrite_products" value="true" checked> Yes &nbsp;
						<input type="radio" name="overwrite_products" value="false"> No
				</tr>
				<tr><td colspan="2">&nbsp;</td></tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="radio" name="overwrite_options" value="true" checked> Yes &nbsp;
						<input type="radio" name="overwrite_options" value="false"> No
				</tr>
				<tr><td colspan="2">&nbsp;</td></tr>
