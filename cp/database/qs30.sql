...
CREATE TABLE `buy_buttons` (
  ...
  PRIMARY KEY  (`bbid`)
) ENGINE=MyISAM COMMENT='Defaults for Buy Buttons' AUTO_INCREMENT=1 ;
# --------------------------------------------------------
...
CREATE TABLE `cart_details` (
  ...
  PRIMARY KEY  (`cdid`),
  KEY `cartid` (`cartid`)
) ENGINE=MyISAM COMMENT='Stores selected options for items in the cart' AUTO_INCREMENT=1 ;
# --------------------------------------------------------
...
) ENGINE=MyISAM COMMENT='Maintains selected items for the cart' AUTO_INCREMENT=1 ;
# --------------------------------------------------------
...
CREATE TABLE `install` (
  ...
  PRIMARY KEY  (`iid`)
) ENGINE=MyISAM COMMENT='Installation details' AUTO_INCREMENT=1 ;
# --------------------------------------------------------
...
CREATE TABLE `product_edit` (
  ...
  PRIMARY KEY  (`peid`)
) ENGINE=MyISAM COMMENT='Used for the product and option edit screens' AUTO_INCREMENT=1 ;
